...
from GenerativeBrainModel.models.spatiotemporal import SpatioTemporalBrainModel
...
class GBM(nn.Module):
    def __init__(self, d_model, n_heads, n_layers, autoencoder_path=None, volume_size=(256, 128, 30), region_size=(32, 16, 2)):
        ...
        self.layers = nn.ModuleList([SpatioTemporalBrainModel(d_model, n_heads, self.n_regions) for _ in range(n_layers)])
