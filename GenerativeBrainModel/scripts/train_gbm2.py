...
def main():
    ...
    gbm_cfg = GBMConfig(
        ...
        gate_capacity=(int(m["gate_capacity"]) if "gate_capacity" in m and m["gate_capacity"] is not None else None),
        gate_fraction=(float(m["gate_fraction"]) if "gate_fraction" in m and m["gate_fraction"] is not None else None),
